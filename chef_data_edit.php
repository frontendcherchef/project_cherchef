...
<?php include __DIR__ . '/_navbar.php'; ?>
    ...
    <div class="container">
        ...
        <div class="center_div">
            <a href="chef.php">
                <button type="button" class="btn btn-primary  col-md-3 "><-回到資料表</button>
            </a>
        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-3 d-flex">
                                                ...
                                                <input <?= $row['restaurant'] == 1 ? 'checked' : " " ?> type="radio"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-3 d-flex">
                                            ...
                                            <input <?= $row['own_kitchen'] == 1 ? 'checked' : " " ?> type="radio"
                                                                                                     class="form-control mini-radio"
                                                                                                     id="yesk"
                                                                                                     name="own_kitchen"
                                                                                                     value="1">
                                        ...
                                        <div class="col-3 d-flex">
                                            ...
                                            <input <?= $row['own_kitchen'] == 0 ? 'checked' : " " ?> type="radio"
                                                                                                      class="form-control mini-radio"
                                                                                                      id="nok"
                                                                                                      name="own_kitchen"
                                                                                                      value="0">
