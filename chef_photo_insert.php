        ...
        <div class="col-lg-6 center_div">
            ...
            <div class="card">
              ...
              <div class="form-group">
                    ...
                    <form name="form1"action="chef_photo_insert_api.php" method="post" enctype="multipart/form-data">
                    ...
                    <br>
                    <br>
                    <button type="submit" class="btn btn-primary btn-lg btn-block" name="submit">上傳圖片</button>
...
<script>
        ...
        const checkForm = ()=>{
            ...
            if(isPassed) {
                ...
                fetch('chef_photo_data_insert_api.php', {
                    method: 'POST',
                    body: form
                })
