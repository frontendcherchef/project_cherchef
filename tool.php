...
<div class="center_div">
  <a href="tool_data_insert.php"><button type="button" class="btn btn-primary  col-md-3  ">新增資料</button></a>
  <a href="tool_insert.php"><button type="button" class="btn btn-primary  col-md-3  ">新增一筆測試資料</button></a>
  <a href="tool_insert.php"><button type="button" class="btn btn-primary  col-md-3  ">管理圖片</button></a>
  <br>
</div>
<br>
