...
<div class="container">
    ...
    <a href="data_food_set_photo.php"><button type="button" class="btn btn-warning  col-md-3 "><-回到圖片資料表</button></a>
            ...
            <div class="card">
              ...
              <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="food_set_sid" name="food_set_sid" placeholder="" value="">
                        選擇上傳檔案:
                         <br>                
        ...
        const checkForm = ()=>{
            ...
            console.log(fsv);
             ...
             if(isPassed) {
                ...
                fetch('data_food_set_photo_insert_api.php', {
                    method: 'POST',
                    body: form
                })
