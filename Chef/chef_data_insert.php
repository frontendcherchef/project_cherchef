                                    ...
                                    <form name="form1" method="post" onsubmit="return checkForm();">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="info" name="info"
                                                placeholder="簡要介紹你自己..." cols="30" rows="3"></textarea>

                                        </div>
                                        <div class="form-group">
                                            <label for="experience">工作經歷 (選填)</label>
                                            <textarea class="form-control" id="experience" name="experience"
                                                placeholder="敘述你曾經在何處任職以及年份..." cols="30" rows="3"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex flex-wrap justify-content-between">
                                                ...
                                                <div style="display:inline-block">
                                                    <input class="mini-radio " type="checkbox"
                                                        id="tool_<?= $tool['sid'] ?>" name="tool[]"
                                                        value="<?= $tool['sid'] ?>">
                                                    <label for="tool_<?= $tool['sid'] ?>"
                                                        class="form-label mini-label"><?= $tool['tool_name'] ?></label>
                                                </div>
                                                <?php endforeach ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="note" name="note"
                                                placeholder="賓客預訂前有甚麼需要注意的?" cols="30" rows="3"></textarea>
                                        </div>
