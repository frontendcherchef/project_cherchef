...
<div class="container">
    ...
    <a href="add_utensils_photo.php"><button type="button" class="btn btn-warning  col-md-3 "><-回到圖片資料表</button></a>
            ...
            <div class="card">
              ...
              <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="add_utensils_sid" name="add_utensils_sid" placeholder="" value="">
                        選擇上傳檔案:
                         <br>                
...
<script>
        ...
        const checkForm = ()=>{
            ...
            fetch('add_utensils_photo_insert_api.php', {
                    method: 'POST',
                    body: form
                })
