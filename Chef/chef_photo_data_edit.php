...
<div class="container">
    ...
    <div class="center_div">
        <a href="chef_photo.php"><button type="button" class="btn btn-warning  col-md-3 ">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <form name="form1" action="chef_photo_data_edit_api.php" method="post"
                                        enctype="multipart/form-data">

                                        <div class="form-group">
                                            <input type="hidden" name="sid" value="<?= $row['sid']?>">
                                            <input type="hidden" name="file_name" value="<?= $row['file_name']?>">
                                            <label for="chef_sid">廚師姓名</label>
                                            <select name="chef_sid" id="chef_sid" disabled>
                                                <?php foreach($all_chef as $chef):?>
                                                <option value="<?= $chef['sid'] ?>" <?=$chef['sid']==$row['chef_sid']? 'selected':"" ?>> <?=$chef['name'] ?></option>
                                                <?php endforeach;?>
                                            </select><br>
                                            選擇上傳檔案:
                                            <br>
