...
$sql = "SELECT * FROM food_style WHERE sid=$sid";

$stmt = $pdo->query($sql);
if($stmt->rowCount()==0){
    header('Location: data_food_style.php');
    exit;
}
...
<div class="container">
    ...
    <div class="row d-flex flex-column align-items-center">
                ...
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="return checkForm();">
                        ...
                        <div class="form-group">
                            <label for="name">料理風格</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder=""
                                   value="">
                            
                        </div>
                        <div class="form-group">
                            <label for="class">階層關聯</label>
                            <input type="text" class="form-control" id="class" name="class" placeholder=""
                                   value="">
                           
                        </div>
                        <div class="form-group">
                            <label for="nickname">風格別名</label>
        ...
        <div class="pt-3 text-nowrap">
            <a href="data_food_style.php"><button type="button" class="btn btn-warning">回到資料表</button></a>
        </div>
    </div>
    ...
    <script>
        ...
        const checkForm = ()=>{
            ...
            if(isPassed) {
                ...
                fetch('data_food_style_edit_api.php', {
                    method: 'POST',
                    body: form
                })
