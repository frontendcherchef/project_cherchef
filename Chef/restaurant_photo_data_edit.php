...
$sql = "SELECT * FROM restaurant_photo WHERE sid=$sid";
...
<div class="container">
    ...
    <a href="restaurant_photo.php"><button type="button" class="btn btn-warning  col-md-3 "><-回到資料表</button></a>
    </div>
            ...
            <div class="card">
              ...
              <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="restaurant_sid" name="restaurant_sid" placeholder="" value="<?= $row['restaurant_sid']?>">
                        選擇上傳檔案:
                         <br>                
    ...
    <script>
        ...
        const checkForm = ()=>{
            ...
            if(isPassed) {
                ...
                fetch('restaurant_photo_data_edit_api.php', {
                    method: 'POST',
                    body: form
                })
