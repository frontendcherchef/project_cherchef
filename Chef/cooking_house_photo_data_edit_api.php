...
if(isset($_POST['cooking_house_sid']) and !empty($sid))
{
    ...
    $s_sql = "SELECT * FROM `cooking_house_photo` WHERE `sid`=?";
    ...
    $sql = "UPDATE `cooking_house_photo` SET 
                `cooking_house_sid`=?
                WHERE `sid`=?";
    ...
    $result['errorMsg'] = 'no cooking_house_sid ';
