...
<div class="center_div">
  <a href="chef_photo_insert.php"><button type="button" class="btn btn-warning  col-md-3  ">新增資料</button></a>
  <a href="chef.php"><button type="button" class="btn btn-warning  col-md-3  ">回到廚師資料表</button></a>
  <br>
</div>
<br>
