...
<br>
<div class="container">
<div class="form_data_font_style" style="color:orange;">料理空間圖片資料表</div>
...
<div class="center_div">
  <a href="cooking_house_photo_insert.php"><button type="button" class="btn btn-warning  col-md-3  ">新增資料</button></a>
