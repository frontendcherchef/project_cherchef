...
$sql = "SELECT * FROM add_utensils_photo WHERE sid=$sid";
...
<div class="container">
    ...
    <a href="add_utensils_photo.php"><button type="button" class="btn btn-warning  col-md-3 "><-回到資料表</button></a>
    </div>
            ...
            <div class="card">
              ...
              <div class="form-group">
                    ...
                    <div class="form-group">
                             ...
                             <label for="add_utensils_sid">餐具sid</label>
                            <input type="text" class="form-control" id="add_utensils_sid" name="add_utensils_sid" placeholder="" value="<?= $row['add_utensils_sid']?>">
                        選擇上傳檔案:
                         <br>                
    ...
    <script>
        ...
        const checkForm = ()=>{
            ...
            fetch('add_utensils_photo_data_edit_api.php', {
                    method: 'POST',
                    body: form
                })
