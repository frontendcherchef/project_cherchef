...
$sql = "SELECT * FROM food_set_meal WHERE sid=$sid";
...
<div class="container">
    ...
    <div class="row d-flex flex-column align-items-center">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="return checkForm();">
                        ...
                        <div class="form-group">
                            <label for="food_set_class">套餐大項sid</label>
                            <input type="text" class="form-control" id="food_set_class" name="food_set_class" placeholder=""
                                   value="">
        ...
        <div class="pt-3 text-nowrap">
            <a href="data_food_set_meal.php"><button type="button" class="btn btn-warning">回到資料表</button></a>
        </div>
    </div>
    ...
    <script>
        ...
        const checkForm = ()=>{
            ...
            if(isPassed) {
                ...
                fetch('data_food_set_meal_edit_api.php', {
                    method: 'POST',
                    body: form
                })
