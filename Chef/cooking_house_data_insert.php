...
<div class="container">
    ...
    <a href="cooking_house.php"><button type="button" class="btn btn-warning  col-md-3 "><-回到資料表</button></a>
    </div>
              ...
              <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="return checkForm();">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="phone" name="phone" placeholder="0913"
                                   value="">
