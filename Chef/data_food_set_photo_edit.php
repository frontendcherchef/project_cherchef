...
$sql = "SELECT * FROM food_set_photo WHERE sid=$sid";
...
<div class="container">
    ...
    <a href="food_set_photo.php"><button type="button" class="btn btn-warning col-md-3 "><-回到資料表</button></a>
    </div>
            ...
            <div class="card">
              ...
              <div class="form-group">
                    ...
                    <div class="form-group">
                             ...
                             <label for="food_set_sid">套餐sid</label>
                            <input type="text" class="form-control" id="food_set_sid" name="food_set_sid" placeholder="" value="<?= $row['food_set_sid']?>">
                        選擇上傳檔案:
                         <br>                
