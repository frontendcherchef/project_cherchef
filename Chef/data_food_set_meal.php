<?php
    ...
    // 算總筆數
    $t_sql = "SELECT COUNT(1) FROM food_set_meal";
    ...
    // $sql = sprintf("SELECT a.sid, a.name, b.name c FROM food_set_meal a INNER JOIN food_set_class b ON a.food_set_class = b.sid ORDER BY sid DESC LIMIT %s, %s", ($page-1)*$per_page, $per_page);
    $sql = sprintf("SELECT a.sid, a.name, b.name c FROM food_set_meal a INNER JOIN food_set_class b ON a.food_set_class = b.sid ORDER BY sid DESC LIMIT %s, %s", 1, $total_rows);
    $stmt = $pdo->query($sql);
...
<div class="container pt-3">
    <h5 class="mb-2" style="color:#e29346">套餐細項資料表</h5>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="float-right mb-2">
                <a href="data_food_set_meal_insert.php"><button type="button" class="btn btn-warning">新增資料表</button></a>
            </div>
        ...
        <div class="col-lg-12 table-responsive card-list-table">
            ...
            >
                ...
                <tr>
                    ...
                    <th scope="col" data-sortable="true">套餐細項</th>
                ...
                <tr>
                    ...
                    <td data-title="套餐大項"><?= $row['c'] ?></td>
                    <td data-title="編輯">
                        <a class="fascl fascl-edit" href="data_food_set_meal_edit.php?sid=<?= $row['sid'] ?>">
