...
<div class="container">
    ...
    <a href="chef_photo.php"><button type="button" class="btn btn-primary  col-md-3 "><-回到資料表</button></a>
    </div>
        ...
        <div class="col-lg-6 center_div">
            ...
            <div class="card">
              ...
              <div class="form-group">
                    ...
                    <form name="form1" action="chef_photo_data_edit_api.php" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                             <input type="hidden" name="sid" value="<?= $row['sid']?>">
                             <input type="hidden" name="file_name" value="<?= $row['file_name']?>">
                             <label for="chef_sid">廚師sid</label>
                            <input type="text" class="form-control" id="chef_sid" name="chef_sid" placeholder="" value="<?= $row['chef_sid']?>">
                        選擇上傳檔案:
                         <br>                
                         <input type="file" name="my_file" multiple="multiple"><br> 
                    <br>
                    <br>
                    <button type="submit" class="btn btn-primary btn-lg btn-block" >上傳圖片</button>
